...
namespace BIBLIOTEKA_NR1.NieLiniowe
{
    /// <summary>
    /// Delegat dla funkcji wektorowej
    /// </summary>
    public delegate double[] FunWektorWektor(double[] X);
    public abstract class Metode_Newtona
    {
        /// <summary>
        ...
        protected double eps, //Dokladość iteracji
                              epsr,//Względny krok różniczkowania przy wyznaczeniu macierzy Jacobiego 
    ...
    public abstract double[] FunWektorWektor(double[] X);
        ...
        public Metode_Newtona(int N1, double[] X0, double eps,
            ...
            double[] X, int M, double eps2)
        {
            ...
            try
            {
                ...
                for (i = 1; i <= N; i++)
                {
                    ...
                    //Podstawienie tablicy wejściowej X do X1 
                    X1 = (double[])X.Clone();
                    X1[i] = X[i] + h;  //Zmiana i-tej składowej X1 o wartość h
...
/// <summary>
/// Klasa pochodna względem klasy Metode_Newtona i abstrakcyjna 
///  zawierająca metodę Rozwiaz() implementującą metodę Newtona
/// </summary>
namespace BIBLIOTEKA_NR1.NieLiniowe
{
    public abstract class Metoda_Newtona_Abstr : Metode_Newtona
    {
        /// <summary>
        ...
        public Metoda_Newtona_Abstr(int N1, double[] X0, double eps,
            double epsr, double epsg, int maxit1) :
        ...
        public override int Rozwiaz()
        {
            ...
            {   //Konstrukcja procesu iteracyjnego (3.11) (3.13)
                ...
                if (blad1 == 0)
                {
                    ...
                    blad2 = Gauss.Rozwiaz(MacJac, XX, dX, epsg);
                    if (blad2 == 0)
                    {
                        for (i = 1; i <= N; i++)
                        {
            ...
            if (blad1 == 0 && blad2 == 0)
            {
                ...
                public class MetodaNewtona : Metoda_Newtona_Abstr
                {
                    ...
                    ///  w metodzie Newtona</param>
                    /// <param name="maxit1">Maksymalna liczba iteracji</param>
                    public MetodaNewtona(FunWektorWektor FNLD, int N1, double[] X0,
